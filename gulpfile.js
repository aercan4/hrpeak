...
const images_path = './src/img/**/*.{gif,svg,jpg,jpeg,png,webp,html,mp4}';
const fonts_path = './src/fonts/**/*.{eot,svg,ttf,woff,woff2}';
const icons_path = './src/icons/**/*.{svg}';
const external_js_path = './src/js/external/**/*.{js,glsl}';
...
gulp.task('move_external_js', function () {
    return gulp.src(external_js_path).pipe(gulp.dest('dist/assets/js/external'));
});
...
gulp.task('watch', function () {
    ...
    gulp.watch(external_js_path, gulp.series('move_external_js'));
...
gulp.task('default', gulp.series('css', 'js', 'pug', 'move_fonts', 'move_icons', 'move_external_js', 'move_images', 'iconfont', 'watch', function () {
}));
